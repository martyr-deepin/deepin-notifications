...
service.input      = files/com.deepin.dde.Notifications.service.in
service.output     = files/com.deepin.dde.Notifications.service
...
service.files += files/com.deepin.dde.Notifications.service files/com.deepin.dde.Notification.service
INSTALLS += service
